    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
      ...
      <div className="flex flex-col items-center text-center  p-4 rounded-lg shadow">
        ...
        <p className="text-sm text-gray-700 mb-4 leading-relaxed">
          Сизга Ўзбекистон Республикаси Президенти виртуал қабулхонаси орқали
          электрон рақамли имзодан фойдаланмаган ҳолда бевосита Ўзбекистон
          Республикаси Президентига электрон тарзда мурожаатларни юбориш
          имконияти тақдим этилади. Шунингдек, Сиз мурожаат юборганингиз тақдим
          этилган калит сўз ёрдамида мурожаатингиз мақомини текшириб кўришингиз
          мумкин.
        </p>
      ...
      <div className="space-y-4">
        ...
        <div className=" p-4 rounded-lg shadow">
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            🇺🇿🇨🇳🇧🇾 Жорий йилнинг 4 июнь санасида Ўзбекистон Миллий Иқтисодий
            Ҳамкорлик уюшмаси ва Хитой Халқ Республикасининг Шенси провинцияси
            вакиллари ўртасида Тошкент шаҳридаги Hilton меҳмонхонасида муҳим ва
            илк расмий мулоқот учрашуви бўлиб ўтди!
          </p>
        </div>
      </div>
